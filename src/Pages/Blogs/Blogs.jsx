...
const Blogs = () => {
    return (
        <div className="px-5 border-l-2 border-r-2">
            ...
            <p>
                <h2 className="text-xl font-semibold underline">How Access Tokens and Refresh Tokens Work:</h2>
                <h3><span className="text-xl font-semibold mt-3 pl-5"> Access Token:</span>
                    <ul>
                        <p className="pl-5">
                ...
                <h3>
                    <span className="text-xl font-semibold pl-5">Refresh Token:</span>
                    <ul>
                        <p className=" pl-5">Refresh tokens are long-lived and are used to obtain new access tokens without requiring the user to re-authenticate. When the access token expires, the client can use the refresh token to request a new access token from the authorization server.</p>
                    </ul>
                </h3>
                <h3>
                    <span className="text-xl font-semibold mt-3 underline">Where to Store Tokens on the Client-Side: </span>
                    <ul>
                        <p className="pl-5">Storing tokens on the client-side should be done with security in mind, as these tokens are sensitive and could potentially be exploited if not handled properly. </p>
                    </ul>
                </h3>
            </p>
            <p>
            ...
            <p>
                ...
                <p className="pl-5">Nest.js is a TypeScript-based web application framework for building scalable and maintainable server-side applications in Node.js. It emphasizes modularity, dependency injection, decorators, and offers features like middleware, database integration, and testing support. It's well-suited for building complex and enterprise-level applications.</p>
            </p>
            <p>
                <h1 className="text-xl font-semibold text-center my-5">- Explain My code -
                </h1>
             <ul className="mb-5">
             <p className="pl-5">
                    ...
                    <br />
                    I used JWT . Its full meaning Json Web Token.
                </p>
             </ul>
            </p>
        </div>
